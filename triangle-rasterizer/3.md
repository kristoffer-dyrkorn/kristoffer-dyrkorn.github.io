...
We are now ready to enter the main loop - where we draw the pixels that lie inside the triangle. This code snippet should look somewhat familiar, it is an extended version of the outline given at the end of [section 1](1).
