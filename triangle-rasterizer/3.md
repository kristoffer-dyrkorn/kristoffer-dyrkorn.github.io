...
draw(screenCoordinates, color) {
    ...
    // in that case, the triangle is ccw oriented
    if (determinant <= 0) {
        return;
    }
...
You might also want to look at [the code for this section](https://github.com/kristoffer-dyrkorn/triangle-rasterizer/tree/main/3) and some [utility classes](https://github.com/kristoffer-dyrkorn/triangle-rasterizer/tree/main/lib). There is also [a running example app](3/) that demonstrates what we have done here.
