...
That's it - that is the method: Finding the start and end points of each horizontal line that will need to be drawn to represent the triangle. And then draw those lines.
